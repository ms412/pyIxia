...
class Pauseframe(object):
    ...
    #    self._api.call('set portlist %s'%(self._TclPortList()))
      #  if self._api.call_rc('ixTakeOwnership portlist force') != 0:
        ...
        for _port in self._portlist:
            self._api.call('port config -enableDataCenterMode true')
            self._api.call('port config -flowControlType ieee8021Qbb')
            self._api.call('port config -pfcEnableValueList "{1 0} {0 2} {1 1} {0 2} {1 3} {0 3} {0 3} {1 1}"')
            self._api.call('port set %d %d %d' % (_port[0], _port[1], _port[2]))
    ...
    def stream(self):
        ...
        self._api.call('stream config -name %s'% 'PFCStream')
        self._api.call('stream config -priorityGroup priorityGroup0')
   ...
   #     self._api.call('stream config -numFrames 1000')
    ...
    def protocol(self):
        ...
        self._api.call('protocol config -name pauseControl')
